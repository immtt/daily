...
| mood | VARCHAR(20) | NULL | 情绪表情 |
| market_snapshot | JSONB | NULL | 四大指数快照；含 snapshotType（intraday/close）、snapshotAt |
